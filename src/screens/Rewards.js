...
const EXPERIENCE_TEXT = 'In Geek House, you can can get various rewards and perks based on your usage.\
...
class Rewards extends React.Component{
  ...
  renderRewards(){
    ...
    return (
      <View style={{marginTop:30}}>
        ...
        <Text style={{fontFamily:FONTS.RALEWAY, fontSize:12, color:COLORS.LESS_DARK, textAlign:'justify'}}>
          # We are currently deciding exciting rewards and perks for you, until then keep 
          using the app and gain XP to get rewards as soon as they arrive.
        </Text>
      </View>
    )
  }
  ...
  render(){
    ...
    return (
      <ScrollView 
        contentContainerStyle={{flexGrow:1, backgroundColor:COLORS.LIGHT, paddingVertical:10, 
