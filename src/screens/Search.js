...
import {FONTS, ERROR_MESSAGES, COLORS_DARK_THEME, COLORS_LIGHT_THEME} from '../Constants';
    ...
    return(
      <View
        ...
        <SearchBar containerStyle={{...styles.SearchContainerStyle, 
          ...
          inputContainerStyle={{backgroundColor:(this.props.theme==='light')?COLORS_LIGHT_THEME.LIGHT:COLORS_DARK_THEME.LESS_LIGHT}}
          inputStyle={{fontSize:16, fontFamily:FONTS.PRODUCT_SANS, color:(this.props.theme==='light')?COLORS_LIGHT_THEME.DARK:COLORS_DARK_THEME.DARK}}
          selectTextOnFocus
  ...
  renderCategory(){
    let jsx = (
      <View style={{alignSelf:'flex-end'}}>
        ...
        theme={this.props.theme} secondaryText={'नई खोज करें'}/>
      </View>)
      ...
      return(
        <View style={{width:"100%"}}>
          <ScrollView style={{flex:1}} nestedScrollEnabled={true} showsVerticalScrollIndicator={false}>
            <ShimmerPlaceHolder colorShimmer={(this.props.theme==='light')?COLORS_LIGHT_THEME.SHIMMER_COLOR:COLORS_DARK_THEME.SHIMMER_COLOR} visible={!this.props.loading} autoRun={true} duration={650} delay={0} 
              ...
              return (
                <View style={{marginTop:25, alignItems:'flex-start', justifyContent:'flex-start'}}>
                  <View style={{flex:1, marginLeft:15 }}>
                    <View style={{borderRadius:5, padding:5, paddingHorizontal:10, borderWidth:2, borderColor:(this.props.theme==='light')?COLORS_LIGHT_THEME.LIGHT_GRAY:COLORS_DARK_THEME.GRAY}}>
                      <Text style={{...styles.CategoryTextStyle, color:(this.props.theme==='light')?COLORS_LIGHT_THEME.LIGHT_GRAY:COLORS_DARK_THEME.GRAY}}>
                        {item}
                      </Text>
                    </View>
                  </View>
