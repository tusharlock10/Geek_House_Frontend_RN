  ...
  switch (action.type){
    ...
    case ACTIONS.SET_CONTENTS:      
      return {...state, contents:action.payload.contents, 
        topic:action.payload.topic, category:action.payload.category}
    ...
    case ACTIONS.CLEAR_WRITE:
      return {...state, loading:false, contents:[], category:'',
        topic:'', image:false, published:false, isDraft:false}

    case ACTIONS.WRITE_SHOW_ALERT:
      return {...state, alertVisible:action.payload.alertVisible, 
