...
export default class MessageContainer extends React.PureComponent {
  constructor() {
    ...
    this.renderRow = ({item, index}) => {
      ...
      if (messages && user) {
        ...
        if (
          item.text &&
          item.text.substring(0, MESSAGE_SPECIAL_ADDER.length) ===
            MESSAGE_SPECIAL_ADDER
        ) {
          return this.renderSpecialMessage(
            item.text.substring(MESSAGE_SPECIAL_ADDER.length),
          );
        }
            ...
            <TouchableOpacity
              ...
              <LinearGradient
                style={{
                  ...
                  elevation: 4,
                  marginHorizontal: 7,
                  borderColor: COLORS_LIGHT_THEME.YELLOW,
                }}
  ...
  render() {
    ...
    return (
      <View style={this.props.alignTop ? styles.containerAlignTop : {flex: 1}}>
          ...
          ListFooterComponent={
            <View
              ...
              <Text
                ...
                {`* Long press on an `}
                <Text style={{fontFamily: FONTS.PRODUCT_SANS_BOLD}}>image</Text>
                {` to save it in gallery\n\
* Long press on `}
                <Text style={{fontFamily: FONTS.PRODUCT_SANS_BOLD}}>text</Text>
