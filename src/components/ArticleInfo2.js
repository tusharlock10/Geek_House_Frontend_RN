...
class ArticleInfo extends PureComponent {
  ...
  renderArticle(){
    ...
    const profileImageScale = this.state.scrollY.interpolate({
      inputRange: [0, HEADER_MAX_HEIGHT - BORDER_RADIUS/2],
      outputRange: [1, 0.2],
      extrapolate: 'clamp'
    });
    const textRotation = this.state.scrollY.interpolate({
    ...
    const textAnim = this.state.scrollY.interpolate({
      inputRange: [0, HEADER_MAX_HEIGHT - HEADER_MIN_HEIGHT],
      outputRange: [0,-PROFILE_IMAGE_MAX_HEIGHT - PROFILE_IMAGE_MAX_HEIGHT/2],
    });
    ...
    const textAnim3 = this.state.scrollY.interpolate({
      inputRange: [0, HEADER_MAX_HEIGHT - HEADER_MIN_HEIGHT +18],
      outputRange: [0,-PROFILE_IMAGE_MAX_HEIGHT - PROFILE_IMAGE_MAX_HEIGHT/2],
    });
        ...
        >
          <Animated.View
            style={{
              ...
              overflow: 'hidden',
              top:HEADER_MAX_HEIGHT - PROFILE_IMAGE_MAX_HEIGHT/2,
              marginLeft: 16,
          ...
          <View>
            ...
            <Image source={require('../../assets/notif_icon')} />
          </View>
