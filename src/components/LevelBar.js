  ...
  return (
    <View style={{width:"100%", height:28, justifyContent:'center', paddingLeft:24, paddingRight:42}}>
      ...
      <View style={{borderRadius:14, height:28, width:28, justifyContent:'center', 
        ...
        <Text style={{fontFamily: FONTS.GOTHAM_BLACK, color:COLORS.GRAY, marginRight:1, marginBottom:1}}>
          {XPObject.level}
        </Text>
      </View>
      <View style={{borderRadius:14, height:28, width:48, justifyContent:'center', 
        alignItems:'center', backgroundColor:COLORS.LESSER_LIGHT, alignSelf:'flex-end',
        position:'absolute', elevation:5}}>
        <Text style={{fontFamily: FONTS.PRODUCT_SANS_BOLD, fontSize:9, color:COLORS.LESS_DARK}}>
          {XPObject.XPToLevelUp}
        </Text>
        <Text style={{fontFamily: FONTS.PRODUCT_SANS, color:COLORS.GRAY, fontSize:7}}>
          XP More
        </Text>
      </View>
    </View>
